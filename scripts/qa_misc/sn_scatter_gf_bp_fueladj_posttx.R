...
# ONLY YEARS POST TREATMENT (NOT BEFORE, NOT YEAR OF)
...
for (p in seq_along(priorities)){
  ...
  #collect all
  all_title <- paste0("Scatter plots AFTER Treatment: Percent Change (fraction) 2m to Baseline (base-2m): ", this_priority)
  ...
  fn_p <- paste0("scatters_POSTONLY_gf_bp_fa_", this_priority, "_v2.jpg")
