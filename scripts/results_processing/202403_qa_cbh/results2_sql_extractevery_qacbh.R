...
# SPECIFICALLY FOR CBH REDUCTION TESTS
# the huc id contains the percentage CBH kept, needed to add in field
...
split_rename_run <- function(df){
  df %>% 
    ...
    # ADDITION HERE
    mutate(cbh_kept = str_split(huc_id, "_")[[1]][3]) %>% 
    #return to normal for rest
