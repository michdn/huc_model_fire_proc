...
#run but not show
res_sc <- read_csv(file.path("..", "..", 
                             "results", "absolute",
                             "SC_absolute_expanded_NOFVS_20240319.csv")) %>% 
  mutate(HUC12 = as.character(HUC12))

res_cc <- read_csv(file.path("..", "..", 
                             "results", "absolute",
...
We'll plot boxplots with the year along the x-axis and different metrics (expBurn and expFlame) on the y-axis. The graphs will facet on intensity and timing group. 
