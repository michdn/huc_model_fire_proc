...
The above examples were exploring a timeslice, a single year. We may also want to look at the results over time. Let's select SC as our region, 'Fire' as the priority, and 'trt4' as the treatment type. We'll look at the three intensities over the four years. 
